...
Deno.serve(async (req) => {
  ...
  const fallback = (): string[] => {
    ...
    const shots = ["wide establishing shot", "close-up of the artist", "dynamic tracking shot", "slow-motion detail", "aerial drone shot", "silhouette against light", "rain and reflections", "crowd energy"];
