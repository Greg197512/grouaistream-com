      ...
      >
        <div className="groove-card p-8">
          ...
          <Button
            ...
            variant="outline"
            className="w-full mb-4 bg-white text-black hover:bg-white/90 border-white/20 font-medium"
          >
            ...
            {googleLoading ? "Łączenie..." : "Kontynuuj z Google"}
          </Button>
          ...
          <div className="relative mb-4">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-card px-2 text-muted-foreground">lub email</span>
            </div>
          </div>
