...
const Index = () => {
  ...
  return (
    <MainLayout>
      ...
      <Section name="g-electronic"><GenreSection genre="Electronic" title="⚡ Elektronika i Synth" icon="electric_bolt" color="text-violet-400" limit={8} /></Section>
      ...
      <Section name="g-soul"><GenreSection genre="Soul" title="✨ Soul i Funk" icon="favorite" color="text-orange-400" limit={8} /></Section>
