...
const en: TranslationKeys = {
  ...
  "upload.tooShort": "Track is too short! Minimum is 2:30.",
  ...
  "upload.monetizeDesc": "Verified listens (min. 30s) count toward your share of the platform's real revenue (ads/subscriptions) — 65% of the pool goes to creators. No fixed per-stream rate; payout once you pass the threshold. You can change this anytime.",
  ...
  "earnings.rate": "Model: 65% share of real revenue (no fixed per-stream rate)",
  ...
  "earnPage.title2": "— fairly, from real revenue",
  "earnPage.subtitle": "Join creators on GrouAI Stream. Free hosting, AI studio, radio and promotion. You earn a share of your music's real revenue (ads/subscriptions) plus listener tips.",
  "earnPage.creatorsCount": "creators already earning",
  "earnPage.threeWays": "Three ways to earn",
  "earnPage.royalties": "Stream Royalties",
  "earnPage.royaltiesD1": "Get a 65% share of the revenue (ads/subscriptions) attributed to your verified listens",
  "earnPage.royaltiesD2": "More real, verified listens → a bigger share for you",
  "earnPage.royaltiesD3": "Paid from revenue that actually came in, above a threshold — no fixed per-listen rate",
  ...
  "earnPage.ctaDesc": "Enable monetization for your tracks — a share of real revenue and tips from listeners.",
  ...
  "earnPage.faq1a": "It depends on the platform's real revenue attributed to your verified listens (a 65% share) plus tips from fans. There's no fixed per-stream rate — we split what actually comes in, so more reach and fan support means more.",
  "earnPage.faq2q": "When do I get paid?",
  "earnPage.faq2a": "We pay out once you pass the minimum threshold (12 $). Tips become payable after a 30-day refund window.",
  ...
  "seo.earn.item1.desc": "Your verified plays (min. 30 seconds, real person) count toward your share of the platform's real revenue — **no artificial per-stream rate; we split what actually comes in.**",
  ...
  "seo.earn.item4.desc": "For your first upload, 50 ratings, 100 likes, completed studio sessions and mood analysis you earn **badges and points** — recognition on your profile, not a payout.",
  "seo.earn.item5.title": "5. 🎪 Weekend Challenges (weekly AI challenges)",
  "seo.earn.item5.desc": "AI generates new challenges every weekend: \"upload 3 tracks\", \"collect 50 likes\", \"host a DJ session\". **Reward: points and a badge.**",
  ...
  "seo.earn.item9.title": "9. 👥 Mood Analysis — points",
  "seo.earn.item9.desc": "Use mood detection via camera and voice — the system rewards active users with points and badges for regular sessions.",
  "seo.weekly.title": "📊 What makes up a creator's income?",
  "seo.weekly.beginner.title": "🌱 Beginner creator (1–5 tracks, 0–100 followers)",
  "seo.weekly.beginner.desc": "Streaming (revenue share) • Tips from fans • Badges and points for activity",
  "seo.weekly.beginner.total": "💵 Usually modest at the start — grows with reach and fan support",
  "seo.weekly.active.title": "🚀 Active creator (10–30 tracks, 500–2000 followers)",
  "seo.weekly.active.desc": "Streaming (share) • Tips • Boost ROI • Badges and points",
  "seo.weekly.active.total": "💵 Regular income from tips and a share of real revenue",
  "seo.weekly.pro.title": "⭐ Professional artist (50+ tracks, 5k+ followers, regular radio rotation)",
  "seo.weekly.pro.desc": "Streaming (share) • Tips • DJ Sessions • Boost",
  "seo.weekly.pro.total": "💵 Significant income with large, active reach",
  "seo.weekly.disclaimer": "⚠️ Income depends on music quality, publishing regularity, fan interaction and use of promotional tools. Streaming is a share of the platform's real revenue (no fixed per-stream rate); payouts after reaching the minimum threshold.",
  "seo.why.title": "🎁 Why does GrouAI Stream pay more than Spotify or SoundCloud?",
  "seo.why.list": "No bots|every stream is a real person = a fairer share of revenue||Multi-channel revenue|not only a share of listens, but also tips and boosts||85% tip commission for the artist|(vs. ~70% market standard)||Organic AI promotion|the system suggests your tracks to listeners matching the mood||Transparency|full real-time earnings dashboard",
