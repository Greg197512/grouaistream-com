...
const ua: TranslationKeys = {
  ...
  "upload.monetizeDesc": "Підтверджені прослуховування (мін. 30 с) зараховуються до вашої частки реального доходу платформи (реклама/підписки) — 65% пулу для авторів. Без фіксованої ставки за стрім; виплата після досягнення порогу. Можна змінити будь-коли.",
  ...
  "earnings.rate": "Модель: 65% частки реального доходу (без фіксованої ставки за стрім)",
  ...
  "earnPage.title2": "— чесно, з реального доходу",
  "earnPage.subtitle": "Приєднуйтесь до авторів на GrouAI Stream. Безкоштовно: хостинг, AI-студія, радіо та просування. Ви заробляєте частку реального доходу вашої музики (реклама/підписки) та чайові від слухачів.",
  ...
  "earnPage.royaltiesD1": "Отримуйте 65% частки доходу (реклама/підписки), віднесеного до ваших підтверджених прослуховувань",
  "earnPage.royaltiesD2": "Більше реальних, підтверджених прослуховувань → більша ваша частка",
  "earnPage.royaltiesD3": "Виплата з коштів, що реально надійшли, після порогу — без фіксованої ставки за прослуховування",
  ...
  "earnPage.ctaDesc": "Увімкніть монетизацію ваших треків — частка реального доходу та чайові від слухачів.",
  ...
  "earnPage.faq1a": "Залежить від реального доходу платформи, віднесеного до ваших підтверджених прослуховувань (частка 65%), і чайових від фанів. Немає фіксованої ставки за стрім — ділимо те, що справді надійшло.",
  "earnPage.faq2q": "Коли я отримаю гроші?",
  "earnPage.faq2a": "Виплату здійснюємо після досягнення мінімального порогу (12 $). Чайові стають доступними після 30-денного вікна повернень.",
  ...
  "seo.earn.item1.desc": "Твої підтверджені відтворення (мін. 30 секунд, реальна людина) зараховуються до твоєї частки реального доходу платформи — **без штучної ставки за стрім; ділимо те, що справді надійшло.**",
  ...
  "seo.earn.item4.title": "4. 🏆 Відзнаки за етапи",
  "seo.earn.item4.desc": "За перший аплоад, 50 рейтингів, 100 лайків, завершені сесії студії та аналіз настрою ти отримуєш **відзнаки й бали** — визнання у профілі, не виплата.",
  "seo.earn.item5.title": "5. 🎪 Weekend Challenges (щотижневі AI-челенджі)",
  "seo.earn.item5.desc": "AI генерує щовихідних нові виклики: «завантаж 3 треки», «збери 50 лайків», «організуй DJ-сесію». **Нагорода: бали та відзнака.**",
  ...
  "seo.earn.item9.title": "9. 👥 Mood Analysis — бали",
  "seo.earn.item9.desc": "Користуйся детекцією настрою через камеру та голос — система винагороджує активних користувачів балами та відзнаками за регулярні сесії.",
  "seo.weekly.title": "📊 З чого складається дохід автора?",
  "seo.weekly.beginner.title": "🌱 Початківець (1–5 треків, 0–100 фоловерів)",
  "seo.weekly.beginner.desc": "Стріми (частка доходу) • Чайові від фанів • Відзнаки й бали за активність",
  "seo.weekly.beginner.total": "💵 На старті зазвичай символічно — росте з охопленням і підтримкою фанів",
  "seo.weekly.active.title": "🚀 Активний автор (10–30 треків, 500–2000 фоловерів)",
  "seo.weekly.active.desc": "Стріми (частка) • Чайові • Boost ROI • Відзнаки й бали",
  "seo.weekly.active.total": "💵 Регулярний дохід із чайових і частки реального доходу",
  "seo.weekly.pro.title": "⭐ Професійний артист (50+ треків, 5k+ фоловерів, регулярна радіо-ротація)",
  "seo.weekly.pro.desc": "Стріми (частка) • Чайові • DJ Sessions • Boost",
  "seo.weekly.pro.total": "💵 Значний дохід за великого, активного охоплення",
  "seo.weekly.disclaimer": "⚠️ Дохід залежить від якості музики, регулярності публікацій, взаємодії з фанами та використання промо-інструментів. Стріми — це частка реального доходу платформи (без фіксованої ставки за стрім); виплати після досягнення мінімального порогу.",
  "seo.why.title": "🎁 Чому GrouAI Stream платить більше, ніж Spotify чи SoundCloud?",
  "seo.why.list": "Жодних ботів|кожен стрім — реальна людина = чесніша частка доходу||Багатоканальний дохід|не лише частка з прослуховувань, а й чайові та бусти||85% комісії з чайових артисту|(проти ~70% ринкового стандарту)||Органічна AI-промоція|система сама пропонує твої треки слухачам, що пасують за настроєм||Прозорість|повна панель доходів у реальному часі",
