...
const pl: TranslationKeys = {
  ...
  "upload.lengthMin": "📏 Długość min. 2:30",
  ...
  "upload.fileTooShort": "za krótki! Min. 2:30",
  ...
  "upload.monetizeDesc": "Zweryfikowane odsłuchania (min. 30 s) liczą się do Twojego udziału w realnym przychodzie platformy (reklamy/subskrypcje) — 65% puli dla twórców. Bez stałej stawki za odsłuch; wypłata po przekroczeniu progu. Możesz to zmienić w każdej chwili.",
  ...
  "earnings.rate": "Model: 65% udziału z realnego przychodu (bez stałej stawki za stream)",
  ...
  "earnPage.title2": "— uczciwie, z realnego przychodu",
  "earnPage.subtitle": "Dołącz do twórców na GrouAI Stream. Za darmo: hosting, AI-studio, radio i promocja. Zarabiasz udziałem z realnego przychodu Twojej muzyki (reklamy/subskrypcje) oraz z tipów słuchaczy.",
  "earnPage.creatorsCount": "twórców już z nami",
  "earnPage.threeWays": "Trzy sposoby na zarobek",
  "earnPage.royalties": "Udział w przychodach",
  "earnPage.royaltiesD1": "Dostajesz 65% udziału z przychodu (reklamy/subskrypcje) przypisanego do Twoich zweryfikowanych odsłuchań",
  "earnPage.royaltiesD2": "Im więcej realnych, zweryfikowanych odsłuchań → tym większy Twój udział",
  "earnPage.royaltiesD3": "Wypłata z puli, która faktycznie wpłynęła, po przekroczeniu progu — bez stałej stawki za odsłuch",
  "earnPage.tips": "Tipy od słuchaczy",
  "earnPage.tipsD1": "Dostajesz 90% z każdej dobrowolnej wpłaty (my 10%)",
  "earnPage.tipsD2": 'Przycisk „Wesprzyj artystę" przy każdym utworze',
  "earnPage.tipsD3": "Słuchacze mogą dać 1 $, 2 $, 5 $ lub dowolną kwotę",
  "earnPage.verified": "Pakiety promocji",
  "earnPage.verifiedD1": "Opcjonalnie kupujesz promocję swojego utworu",
  "earnPage.verifiedD2": "Realny boost widoczności — bez botów, tylko prawdziwi słuchacze",
  "earnPage.verifiedD3": "Przyspieszasz wzrost prawdziwych odsłuchań i zasięgu",
  ...
  "earnPage.ctaDesc": "Włącz monetyzację swoich utworów — udział z realnego przychodu i napiwki od słuchaczy.",
  ...
  "earnPage.faq1a": "To zależy od realnego przychodu platformy przypisanego do Twoich zweryfikowanych odsłuchań (udział 65%) oraz napiwków od fanów. Nie ma stałej stawki za odsłuch — dzielimy to, co faktycznie wpłynęło, więc im większy zasięg i wsparcie fanów, tym więcej.",
  "earnPage.faq2q": "Kiedy dostaję pieniądze?",
  "earnPage.faq2a": "Wypłatę realizujemy po przekroczeniu progu minimalnego (12 $). Napiwki stają się wypłacalne po 30-dniowym oknie zwrotów.",
  ...
  "seo.earn.item1.desc": "Twoje zweryfikowane odtworzenia (min. 30 sekund, prawdziwy człowiek) liczą się do Twojego udziału w realnym przychodzie platformy — **bez sztucznej stawki za odsłuch, dzielimy to, co faktycznie wpłynęło.**",
  ...
  "seo.earn.item4.title": "4. 🏆 Odznaki za kamienie milowe",
  "seo.earn.item4.desc": "Za pierwszy upload, 50 ratingów, 100 lajków, ukończone sesje studyjne i analizę nastroju zdobywasz **odznaki i punkty** — wyróżnienie w profilu, nie wypłata.",
  "seo.earn.item5.title": "5. 🎪 Weekend Challenges (cotygodniowe wyzwania AI)",
  "seo.earn.item5.desc": "AI generuje co weekend nowe wyzwanie: \"uploaduj 3 utwory\", \"zbierz 50 lajków\", \"zorganizuj sesję DJ\". **Nagroda: punkty i odznaka.**",
  ...
  "seo.earn.item9.title": "9. 👥 Mood Analysis — punkty",
  "seo.earn.item9.desc": "Korzystaj z detekcji nastroju przez kamerę i głos — system nagradza aktywnych użytkowników punktami i odznakami za regularne sesje.",
  "seo.weekly.title": "📊 Z czego składa się dochód twórcy?",
  "seo.weekly.beginner.title": "🌱 Początkujący twórca (1–5 utworów, 0–100 followersów)",
  "seo.weekly.beginner.desc": "Streaming (udział z przychodu) • Tipy od fanów • Odznaki i punkty za aktywność",
  "seo.weekly.beginner.total": "💵 Na start zwykle symbolicznie — rośnie z zasięgiem i wsparciem fanów",
  "seo.weekly.active.title": "🚀 Aktywny twórca (10–30 utworów, 500–2000 followersów)",
  "seo.weekly.active.desc": "Streaming (udział) • Tipy • Boost ROI • Odznaki i punkty",
  "seo.weekly.active.total": "💵 Regularny dochód z tipów i udziału z realnego przychodu",
  "seo.weekly.pro.title": "⭐ Profesjonalny artysta (50+ utworów, 5k+ followersów, regularny radio rotation)",
  "seo.weekly.pro.desc": "Streaming (udział) • Tipy • DJ Sessions • Boost",
  "seo.weekly.pro.total": "💵 Znaczący dochód przy dużym, aktywnym zasięgu",
  "seo.weekly.disclaimer": "⚠️ Dochód zależy od jakości muzyki, regularności publikacji, interakcji z fanami i wykorzystania narzędzi promocyjnych. Streaming to udział z realnego przychodu platformy (bez stałej stawki za odsłuch); wypłaty po osiągnięciu progu minimalnego.",
  "seo.why.title": "🎁 Dlaczego GrouAI Stream zarabia więcej niż Spotify czy SoundCloud?",
  "seo.why.list": "Brak botów|każdy stream to realny człowiek = uczciwszy udział w przychodzie||Wielokanałowy zarobek|nie tylko udział z odsłuchań, ale też napiwki i boosty||85% prowizji z tipów dla artysty|(vs ~70% standardu rynkowego)||AI promocja organiczna|system sam podsuwa Twoje utwory pasującym nastrojowo słuchaczom||Transparentność|pełen dashboard z przychodami w czasie rzeczywistym",
