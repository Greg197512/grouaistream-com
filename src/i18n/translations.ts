...
type TranslationKeys = {
  ...
  // Mood Detection
  "mood.title": string;
  "mood.subtitle": string;
  "mood.loadingModels": string;
  "mood.loadingWait": string;
  "mood.tfReady": string;
  "mood.deepAnalyzing": string;
  "mood.analyzing": string;
  "mood.initTf": string;
  "mood.detectingFace": string;
  "mood.analyzingExpression": string;
  "mood.recognizingEmotions": string;
  "mood.finalizing": string;
  "mood.noFace": string;
  "mood.noFaceHint": string;
  "mood.tryAgain": string;
  "mood.cameraActive": string;
  "mood.noCameraAccess": string;
  "mood.analyzeBtn": string;
  "mood.loadingAI": string;
  "mood.starting": string;
  "mood.cancel": string;
  "mood.scanAgain": string;
  "mood.confidence": string;
  "mood.diagnosisTitle": string;
  "mood.emotionalStateTitle": string;
  "mood.riskTitle": string;
  "mood.fullAnalysis": string;
  "mood.collapse": string;
  "mood.microExpressions": string;
  "mood.psychInsight": string;
  "mood.therapeuticAdvice": string;
  "mood.musicTherapy": string;
  "mood.healingFreq": string;
  "mood.playing5tracks": string;
  "mood.boostGuarantee": string;
  "mood.goalLabel": string;
  "mood.noTracks": string;
  "mood.trackError": string;
  "mood.faceError": string;
  "mood.analysisError": string;
  "mood.microStep": string;
  "mood.diagStep": string;
  "mood.therapyStep": string;
  "mood.selectionStep": string;
  "mood.professorAnalyzing": string;
  "mood.happy": string;
  "mood.melancholic": string;
  "mood.intense": string;
  "mood.anxious": string;
  "mood.rebellious": string;
  "mood.excited": string;
  "mood.relaxed": string;
  "mood.energetic": string;
  "mood.romantic": string;
  "mood.focused": string;
  "mood.happyDesc": string;
  "mood.sadDesc": string;
  "mood.angryDesc": string;
  "mood.fearfulDesc": string;
  "mood.disgustedDesc": string;
  "mood.surprisedDesc": string;
  "mood.neutralDesc": string;
  "mood.energeticDesc": string;
  "mood.romanticDesc": string;
  "mood.focusedDesc": string;
};
...
const pl: TranslationKeys = {
  ...
  "mood.title": "AI Profesor Psychologii",
  "mood.subtitle": "TensorFlow.js + AI gotowy",
  "mood.loadingModels": "Ładowanie modeli face-api.js...",
  "mood.loadingWait": "To może potrwać kilka sekund",
  "mood.tfReady": "TensorFlow.js gotowy",
  "mood.deepAnalyzing": "Głęboka analiza psychiatryczna...",
  "mood.analyzing": "Analizuję...",
  "mood.initTf": "Inicjalizacja TensorFlow.js...",
  "mood.detectingFace": "Wykrywanie twarzy...",
  "mood.analyzingExpression": "Analiza wyrazu twarzy...",
  "mood.recognizingEmotions": "Rozpoznawanie emocji...",
  "mood.finalizing": "Finalizacja wyników...",
  "mood.noFace": "Nie wykryto twarzy",
  "mood.noFaceHint": "Upewnij się, że twarz jest dobrze oświetlona",
  "mood.tryAgain": "Spróbuj ponownie",
  "mood.cameraActive": "🎥 Kamera aktywna! Analizuję twarz przez 5 sekund...",
  "mood.noCameraAccess": "Brak dostępu do kamery. Sprawdź uprawnienia.",
  "mood.analyzeBtn": "Analizuj emocje (5s)",
  "mood.loadingAI": "Ładowanie AI...",
  "mood.starting": "Uruchamiam...",
  "mood.cancel": "Anuluj",
  "mood.scanAgain": "Skanuj ponownie",
  "mood.confidence": "pewności detekcji",
  "mood.diagnosisTitle": "Diagnoza Profesora",
  "mood.emotionalStateTitle": "Stan Emocjonalny",
  "mood.riskTitle": "Poziom Ryzyka",
  "mood.fullAnalysis": "Pełna analiza psychiatryczna",
  "mood.collapse": "Zwiń",
  "mood.microExpressions": "Mikroekspresje",
  "mood.psychInsight": "Wgląd Psychologiczny",
  "mood.therapeuticAdvice": "Zalecenia Terapeutyczne",
  "mood.musicTherapy": "Muzykoterapia",
  "mood.healingFreq": "Częstotliwość Lecznicza",
  "mood.playing5tracks": "Gram 5 utworów dobranych przez AI Profesora",
  "mood.boostGuarantee": "Humor +100% gwarantowany!",
  "mood.goalLabel": "Cel",
  "mood.noTracks": "Brak utworów w bazie.",
  "mood.trackError": "Błąd podczas ładowania utworów.",
  "mood.faceError": "Błąd podczas analizy twarzy. Spróbuj ponownie.",
  "mood.analysisError": "Nie udało się przeprowadzić głębokiej analizy AI.",
  "mood.microStep": "Analiza mikroekspresji...",
  "mood.diagStep": "Diagnoza psychiatryczna...",
  "mood.therapyStep": "Dobór muzykoterapii...",
  "mood.selectionStep": "Selekcja 5 utworów...",
  "mood.professorAnalyzing": "🧠 Profesor AI analizuje Twój stan...",
  "mood.happy": "Szczęśliwy",
  "mood.melancholic": "Melancholijny",
  "mood.intense": "Intensywny",
  "mood.anxious": "Niespokojny",
  "mood.rebellious": "Buntowniczy",
  "mood.excited": "Podekscytowany",
  "mood.relaxed": "Zrelaksowany",
  "mood.energetic": "Energetyczny",
  "mood.romantic": "Romantyczny",
  "mood.focused": "Skupiony",
  "mood.happyDesc": "Masz świetny dzień! Energia pozytywna promieniuje z Ciebie!",
  "mood.sadDesc": "Wygląda na trudniejszy dzień... Muzyka poprawi Ci nastrój!",
  "mood.angryDesc": "Czujesz się intensywnie! Czas na muzykę, która to uwolni!",
  "mood.fearfulDesc": "Stresujący dzień? Uspokajające dźwięki pomogą!",
  "mood.disgustedDesc": "Buntowniczy nastrój! Rock i punk dla Ciebie!",
  "mood.surprisedDesc": "Pełen ekscytacji dzień! Czas na energetyczną muzykę!",
  "mood.neutralDesc": "Spokojny, zrelaksowany dzień. Idealna pora na chill!",
  "mood.energeticDesc": "WOW! Mega energetyczny dzień! Czas rozkręcić imprezę!",
  "mood.romanticDesc": "Romantyczny nastrój... Czas na piękne melodie!",
  "mood.focusedDesc": "Skupiony i gotowy do działania! Muzyka pomoże!",
};
...
const en: TranslationKeys = {
  ...
  "mood.title": "AI Psychology Professor",
  "mood.subtitle": "TensorFlow.js + AI ready",
  "mood.loadingModels": "Loading face-api.js models...",
  "mood.loadingWait": "This may take a few seconds",
  "mood.tfReady": "TensorFlow.js ready",
  "mood.deepAnalyzing": "Deep psychiatric analysis...",
  "mood.analyzing": "Analyzing...",
  "mood.initTf": "Initializing TensorFlow.js...",
  "mood.detectingFace": "Detecting face...",
  "mood.analyzingExpression": "Analyzing facial expression...",
  "mood.recognizingEmotions": "Recognizing emotions...",
  "mood.finalizing": "Finalizing results...",
  "mood.noFace": "No face detected",
  "mood.noFaceHint": "Make sure your face is well lit",
  "mood.tryAgain": "Try again",
  "mood.cameraActive": "🎥 Camera active! Analyzing face for 5 seconds...",
  "mood.noCameraAccess": "No camera access. Check your permissions.",
  "mood.analyzeBtn": "Analyze emotions (5s)",
  "mood.loadingAI": "Loading AI...",
  "mood.starting": "Starting...",
  "mood.cancel": "Cancel",
  "mood.scanAgain": "Scan again",
  "mood.confidence": "detection confidence",
  "mood.diagnosisTitle": "Professor's Diagnosis",
  "mood.emotionalStateTitle": "Emotional State",
  "mood.riskTitle": "Risk Level",
  "mood.fullAnalysis": "Full psychiatric analysis",
  "mood.collapse": "Collapse",
  "mood.microExpressions": "Micro Expressions",
  "mood.psychInsight": "Psychological Insight",
  "mood.therapeuticAdvice": "Therapeutic Recommendations",
  "mood.musicTherapy": "Music Therapy",
  "mood.healingFreq": "Healing Frequency",
  "mood.playing5tracks": "Playing 5 tracks selected by AI Professor",
  "mood.boostGuarantee": "Mood +100% guaranteed!",
  "mood.goalLabel": "Goal",
  "mood.noTracks": "No tracks in the library.",
  "mood.trackError": "Error loading tracks.",
  "mood.faceError": "Error analyzing face. Try again.",
  "mood.analysisError": "Deep AI analysis failed.",
  "mood.microStep": "Analyzing micro expressions...",
  "mood.diagStep": "Psychiatric diagnosis...",
  "mood.therapyStep": "Selecting music therapy...",
  "mood.selectionStep": "Selecting 5 tracks...",
  "mood.professorAnalyzing": "🧠 AI Professor is analyzing your state...",
  "mood.happy": "Happy",
  ...
  "mood.happyDesc": "You're having a great day! Positive energy radiates from you!",
  "mood.sadDesc": "Looks like a tough day... Music will boost your mood!",
  "mood.angryDesc": "You're feeling intense! Time for music to release it!",
  "mood.fearfulDesc": "Stressful day? Calming sounds will help!",
  "mood.disgustedDesc": "Rebellious mood! Rock and punk for you!",
  "mood.surprisedDesc": "Full of excitement! Time for energetic music!",
  "mood.neutralDesc": "Calm, relaxed day. Perfect time to chill!",
  "mood.energeticDesc": "WOW! Super energetic day! Time to party!",
  "mood.romanticDesc": "Romantic mood... Time for beautiful melodies!",
  "mood.focusedDesc": "Focused and ready to go! Music will help!",
};
...
const nl: TranslationKeys = {
  ...
  "mood.title": "AI Professor Psychologie",
  "mood.subtitle": "TensorFlow.js + AI klaar",
  "mood.loadingModels": "Face-api.js modellen laden...",
  "mood.loadingWait": "Dit kan enkele seconden duren",
  "mood.tfReady": "TensorFlow.js klaar",
  "mood.deepAnalyzing": "Diepe psychiatrische analyse...",
  "mood.analyzing": "Analyseren...",
  "mood.initTf": "TensorFlow.js initialiseren...",
  "mood.detectingFace": "Gezicht detecteren...",
  "mood.analyzingExpression": "Gezichtsuitdrukking analyseren...",
  "mood.recognizingEmotions": "Emoties herkennen...",
  "mood.finalizing": "Resultaten afronden...",
  "mood.noFace": "Geen gezicht gedetecteerd",
  "mood.noFaceHint": "Zorg dat je gezicht goed verlicht is",
  "mood.tryAgain": "Probeer opnieuw",
  "mood.cameraActive": "🎥 Camera actief! Gezicht wordt 5 seconden geanalyseerd...",
  "mood.noCameraAccess": "Geen cameratoegang. Controleer je rechten.",
  "mood.analyzeBtn": "Emoties analyseren (5s)",
  "mood.loadingAI": "AI laden...",
  "mood.starting": "Starten...",
  "mood.cancel": "Annuleren",
  "mood.scanAgain": "Opnieuw scannen",
  "mood.confidence": "detectie zekerheid",
  "mood.diagnosisTitle": "Diagnose van de Professor",
  "mood.emotionalStateTitle": "Emotionele Toestand",
  "mood.riskTitle": "Risiconiveau",
  "mood.fullAnalysis": "Volledige psychiatrische analyse",
  "mood.collapse": "Inklappen",
  "mood.microExpressions": "Micro-expressies",
  "mood.psychInsight": "Psychologisch Inzicht",
  "mood.therapeuticAdvice": "Therapeutische Aanbevelingen",
  "mood.musicTherapy": "Muziektherapie",
  "mood.healingFreq": "Helende Frequentie",
  "mood.playing5tracks": "5 nummers geselecteerd door AI Professor",
  "mood.boostGuarantee": "Stemming +100% gegarandeerd!",
  "mood.goalLabel": "Doel",
  "mood.noTracks": "Geen nummers in de bibliotheek.",
  "mood.trackError": "Fout bij laden van nummers.",
  "mood.faceError": "Fout bij gezichtsanalyse. Probeer opnieuw.",
  "mood.analysisError": "Diepe AI-analyse mislukt.",
  "mood.microStep": "Micro-expressies analyseren...",
  "mood.diagStep": "Psychiatrische diagnose...",
  "mood.therapyStep": "Muziektherapie selecteren...",
  "mood.selectionStep": "5 nummers selecteren...",
  "mood.professorAnalyzing": "🧠 AI Professor analyseert je toestand...",
  "mood.happy": "Gelukkig",
  "mood.melancholic": "Melancholisch",
  "mood.intense": "Intens",
  "mood.anxious": "Angstig",
  "mood.rebellious": "Rebels",
  "mood.excited": "Opgewonden",
  "mood.relaxed": "Ontspannen",
  "mood.energetic": "Energiek",
  "mood.romantic": "Romantisch",
  "mood.focused": "Gefocust",
  "mood.happyDesc": "Je hebt een geweldige dag! Positieve energie straalt van je af!",
  "mood.sadDesc": "Het lijkt een zware dag... Muziek zal je stemming verbeteren!",
  "mood.angryDesc": "Je voelt je intens! Tijd voor muziek om het los te laten!",
  "mood.fearfulDesc": "Stressvolle dag? Kalmerende klanken helpen!",
  "mood.disgustedDesc": "Rebelse stemming! Rock en punk voor jou!",
  "mood.surprisedDesc": "Vol opwinding! Tijd voor energieke muziek!",
  "mood.neutralDesc": "Rustige, ontspannen dag. Perfect moment om te chillen!",
  "mood.energeticDesc": "WOW! Super energieke dag! Tijd om te feesten!",
  "mood.romanticDesc": "Romantische stemming... Tijd voor mooie melodieën!",
  "mood.focusedDesc": "Gefocust en klaar voor actie! Muziek helpt!",
};
...
const ua: TranslationKeys = {
  ...
  "mood.title": "AI Професор Психології",
  "mood.subtitle": "TensorFlow.js + AI готовий",
  "mood.loadingModels": "Завантаження моделей face-api.js...",
  "mood.loadingWait": "Це може тривати кілька секунд",
  "mood.tfReady": "TensorFlow.js готовий",
  "mood.deepAnalyzing": "Глибокий психіатричний аналіз...",
  "mood.analyzing": "Аналізую...",
  "mood.initTf": "Ініціалізація TensorFlow.js...",
  "mood.detectingFace": "Виявлення обличчя...",
  "mood.analyzingExpression": "Аналіз виразу обличчя...",
  "mood.recognizingEmotions": "Розпізнавання емоцій...",
  "mood.finalizing": "Завершення результатів...",
  "mood.noFace": "Обличчя не виявлено",
  "mood.noFaceHint": "Переконайтесь, що обличчя добре освітлене",
  "mood.tryAgain": "Спробувати знову",
  "mood.cameraActive": "🎥 Камера активна! Аналізую обличчя протягом 5 секунд...",
  "mood.noCameraAccess": "Немає доступу до камери. Перевірте дозволи.",
  "mood.analyzeBtn": "Аналізувати емоції (5с)",
  "mood.loadingAI": "Завантаження AI...",
  "mood.starting": "Запуск...",
  "mood.cancel": "Скасувати",
  "mood.scanAgain": "Сканувати знову",
  "mood.confidence": "впевненість детекції",
  "mood.diagnosisTitle": "Діагноз Професора",
  "mood.emotionalStateTitle": "Емоційний Стан",
  "mood.riskTitle": "Рівень Ризику",
  "mood.fullAnalysis": "Повний психіатричний аналіз",
  "mood.collapse": "Згорнути",
  "mood.microExpressions": "Мікровирази",
  "mood.psychInsight": "Психологічний Інсайт",
  "mood.therapeuticAdvice": "Терапевтичні Рекомендації",
  "mood.musicTherapy": "Музикотерапія",
  "mood.healingFreq": "Цілюща Частота",
  "mood.playing5tracks": "Граю 5 треків, підібраних AI Професором",
  "mood.boostGuarantee": "Настрій +100% гарантовано!",
  "mood.goalLabel": "Ціль",
  "mood.noTracks": "Немає треків у бібліотеці.",
  "mood.trackError": "Помилка завантаження треків.",
  "mood.faceError": "Помилка аналізу обличчя. Спробуйте знову.",
  "mood.analysisError": "Глибокий AI аналіз не вдався.",
  "mood.microStep": "Аналіз мікровиразів...",
  "mood.diagStep": "Психіатричний діагноз...",
  "mood.therapyStep": "Підбір музикотерапії...",
  "mood.selectionStep": "Відбір 5 треків...",
  "mood.professorAnalyzing": "🧠 AI Професор аналізує ваш стан...",
  "mood.happy": "Щасливий",
  "mood.melancholic": "Меланхолійний",
  "mood.intense": "Інтенсивний",
  "mood.anxious": "Тривожний",
  "mood.rebellious": "Бунтівний",
  "mood.excited": "Збуджений",
  "mood.relaxed": "Розслаблений",
  "mood.energetic": "Енергійний",
  "mood.romantic": "Романтичний",
  "mood.focused": "Зосереджений",
  "mood.happyDesc": "У вас чудовий день! Позитивна енергія випромінює від вас!",
  "mood.sadDesc": "Виглядає на важкий день... Музика покращить настрій!",
  "mood.angryDesc": "Ви відчуваєте інтенсивно! Час для музики, щоб звільнити це!",
  "mood.fearfulDesc": "Стресовий день? Заспокійливі звуки допоможуть!",
  "mood.disgustedDesc": "Бунтівний настрій! Рок і панк для вас!",
  "mood.surprisedDesc": "Повні збудження! Час для енергійної музики!",
  "mood.neutralDesc": "Спокійний, розслаблений день. Ідеальний час для відпочинку!",
  "mood.energeticDesc": "ВАУ! Супер енергійний день! Час запалювати!",
  "mood.romanticDesc": "Романтичний настрій... Час для прекрасних мелодій!",
  "mood.focusedDesc": "Зосереджений і готовий до дії! Музика допоможе!",
};
