...
const pl: TranslationKeys = {
  ...
  "legal.terms.s2.badgeDesc": "Karon znajduje się obecnie w fazie rozwojowej (pre-launch). Formalna rejestracja w KvK oraz uzyskanie numeru BTW (VAT) nastąpi zgodnie z holenderskim prawem handlowym po spełnieniu progów rejestracyjnych, uzależnionych od liczby aktywnych użytkowników i obrotów.",
  ...
  "legal.priv.s1.p1": "Administratorem danych osobowych jest Karon, Holandia. Mamy siedzibę w UE, więc obowiązuje nas pełne RODO. Pisz do nas śmiało: privacy@grouai.stream — odpisujemy po ludzku, nie szablonem.",
...
const en: TranslationKeys = {
  ...
  "legal.terms.s1.p2": "2. The Service is operated by Karon — a pre-registration project based in the Netherlands. Registration with the Chamber of Commerce (Kamer van Koophandel, KvK) will take place after achieving a sufficient user base. Until then, the Service operates as a sole proprietorship (eenmanszaak) under Dutch law.",
  ...
  "legal.terms.s2.badgeDesc": "Karon is currently in the development phase (pre-launch). Formal registration with KvK and obtaining a BTW (VAT) number will occur in accordance with Dutch commercial law after meeting registration thresholds based on the number of active users and revenue.",
  ...
  "legal.priv.s1.p1": "The data controller is Karon, Netherlands. We're EU-based, so full GDPR applies. Reach out anytime: privacy@grouai.stream — we reply like humans, not templates.",
...
const nl: TranslationKeys = {
  ...
  "legal.terms.s1.p2": "2. De Dienst wordt beheerd door Karon — een pre-registratieproject gevestigd in Nederland. Registratie bij de Kamer van Koophandel (KvK) vindt plaats na het bereiken van een voldoende gebruikersbasis. Tot die tijd opereert de Dienst als eenmanszaak volgens Nederlands recht.",
  ...
  "legal.terms.s2.badgeDesc": "Karon bevindt zich momenteel in de ontwikkelingsfase (pre-launch). Formele registratie bij KvK en het verkrijgen van een BTW-nummer zal plaatsvinden in overeenstemming met het Nederlandse handelsrecht na het bereiken van registratiedrempels op basis van het aantal actieve gebruikers en omzet.",
  ...
  "legal.priv.s1.p1": "De verwerkingsverantwoordelijke is Karon, Nederland. We zijn EU-gevestigd, dus volledige AVG is van toepassing. Neem gerust contact op: privacy@grouai.stream — we antwoorden als mensen, niet met templates.",
  ...
  "legal.copy.bases.auteurswet": "• Nederlandse Auteurswet — auteursrecht en naburige rechten",
...
const ua: TranslationKeys = {
  ...
  "legal.terms.s1.p2": "2. Сервіс управляється Karon — проект у фазі попередньої реєстрації, з запланованим місцезнаходженням у Нідерландах. Реєстрація в Торговій палаті (Kamer van Koophandel, KvK) відбудеться після досягнення достатньої бази користувачів. До цього моменту Сервіс працює як індивідуальне підприємство (eenmanszaak) за голландським правом.",
  ...
  "legal.terms.s2.badgeDesc": "Karon наразі перебуває у фазі розробки (pre-launch). Формальна реєстрація в KvK та отримання номера BTW (ПДВ) відбудеться відповідно до голландського комерційного права після досягнення реєстраційних порогів, залежних від кількості активних користувачів та обороту.",
  ...
  "legal.priv.s1.p1": "Контролером персональних даних є Karon, Нідерланди. Ми зареєстровані в ЄС, тому застосовується повний GDPR. Звертайтесь сміливо: privacy@grouai.stream — відповідаємо по-людськи, а не шаблонами.",
  ...
  "legal.priv.s8.p1": "Тільки з перевіреними постачальниками інфраструктури (хостинг, сховище), виключно за підписаними угодами про обробку даних (DPA) та Стандартними Договірними Застереженнями (SCC). ПЛАТІЖНІ ДАНІ ТА PADDLE: Усі платежі (підписки Pro/Ultimate, кавові чайові) обробляються Paddle.com Market Limited (Великобританія), що діє як наш Merchant of Record та незалежний контролер платіжних даних. Paddle обробляє дані вашої картки, платіжну адресу, email та IP-адресу для обробки платежів, запобігання шахрайству, виставлення рахунків та податкової відповідності. Karon ніколи не бачить і не зберігає повний номер вашої картки. Політика Paddle: https://www.paddle.com/legal/privacy",
  ...
  "legal.copy.sources.ai": "5. AI-треки (Suno, Udio, AIVA та інші) — Ви завантажуєте AI-треки за вашою ліцензією (наприклад, Suno Pro/Premier). Ви надаєте нам НЕВИКЛЮЧНУ, загальносвітову, безоплатну ліцензію виключно на відтворення та представлення на нашій платформі. ВИ ЗБЕРІГАЄТЕ ПОВНІ ПРАВА — можете публікувати той самий трек на Spotify, YouTube, TikTok, через DistroKid/TuneCore, продавати, реміксувати. Ваш творчий внесок (prompt, відбір, редагування) захищений відповідно до EUIPO та голландського Auteurswet.",
