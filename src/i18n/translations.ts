...
const ua: TranslationKeys = {
  ...
  "legal.priv.s8.p1": "Тільки з перевіреними постачальниками інфраструктури (хостинг, сховище), виключно за підписаними угодами про обробку даних (DPA) та Стандартними Договірними Застереженнями (SCC). Список відкритий — напишіть, якщо хочете повний.",
