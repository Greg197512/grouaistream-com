...
const nl: TranslationKeys = {
  ...
  "upload.monetizeDesc": "Geverifieerde luisterbeurten (min. 30s) tellen mee voor jouw aandeel in de echte omzet van het platform (advertenties/abonnementen) — 65% van de pool gaat naar artiesten. Geen vast tarief per stream; uitbetaling zodra je de drempel bereikt. Je kunt dit altijd wijzigen.",
  ...
  "earnings.rate": "Model: 65% aandeel in de echte omzet (geen vast tarief per stream)",
  ...
  "earnPage.title2": "— eerlijk, uit echte inkomsten",
  "earnPage.subtitle": "Sluit je aan bij artiesten op GrouAI Stream. Gratis hosting, AI-studio, radio en promotie. Je verdient een aandeel van de echte inkomsten van je muziek (advertenties/abonnementen) plus fooien van luisteraars.",
  ...
  "earnPage.royaltiesD1": "Ontvang 65% aandeel van de inkomsten (advertenties/abonnementen) toegewezen aan je geverifieerde luisterbeurten",
  "earnPage.royaltiesD2": "Meer echte, geverifieerde luisterbeurten → een groter aandeel voor jou",
  "earnPage.royaltiesD3": "Uitbetaald uit inkomsten die echt binnenkwamen, boven een drempel — geen vast tarief per luisterbeurt",
  ...
  "earnPage.ctaDesc": "Schakel monetisatie in voor je nummers — een aandeel in de echte omzet en tips van luisteraars.",
  ...
  "earnPage.faq1a": "Het hangt af van de echte omzet van het platform die aan je geverifieerde luisterbeurten wordt toegekend (een aandeel van 65%) plus tips van fans. Er is geen vast tarief per stream — we verdelen wat er daadwerkelijk binnenkomt.",
  "earnPage.faq2q": "Wanneer word ik betaald?",
  "earnPage.faq2a": "We betalen uit zodra je de minimumdrempel (12 $) bereikt. Tips worden uitbetaalbaar na een terugbetalingsperiode van 30 dagen.",
  ...
  "seo.earn.item1.desc": "Je geverifieerde afspeelbeurten (min. 30 seconden, echte persoon) tellen mee voor jouw aandeel in de echte omzet van het platform — **geen kunstmatig tarief per stream; we verdelen wat er daadwerkelijk binnenkomt.**",
  ...
  "seo.earn.item4.title": "4. 🏆 Milestone-badges",
  "seo.earn.item4.desc": "Voor je eerste upload, 50 ratings, 100 likes, voltooide studiosessies en moodanalyse verdien je **badges en punten** — erkenning op je profiel, geen uitbetaling.",
  "seo.earn.item5.title": "5. 🎪 Weekend Challenges (wekelijkse AI-uitdagingen)",
  "seo.earn.item5.desc": "AI genereert elk weekend nieuwe uitdagingen: \"upload 3 tracks\", \"verzamel 50 likes\", \"host een DJ-sessie\". **Beloning: punten en een badge.**",
  ...
  "seo.earn.item9.title": "9. 👥 Mood Analysis — punten",
  "seo.earn.item9.desc": "Gebruik moodetectie via camera en stem — het systeem beloont actieve gebruikers met punten en badges voor reguliere sessies.",
  "seo.weekly.title": "📊 Waaruit bestaat het inkomen van een creator?",
  "seo.weekly.beginner.title": "🌱 Beginnende creator (1–5 tracks, 0–100 volgers)",
  "seo.weekly.beginner.desc": "Streaming (omzetaandeel) • Tips van fans • Badges en punten voor activiteit",
  "seo.weekly.beginner.total": "💵 In het begin meestal bescheiden — groeit met bereik en steun van fans",
  "seo.weekly.active.title": "🚀 Actieve creator (10–30 tracks, 500–2000 volgers)",
  "seo.weekly.active.desc": "Streaming (aandeel) • Tips • Boost ROI • Badges en punten",
  "seo.weekly.active.total": "💵 Regelmatig inkomen uit tips en een aandeel in de echte omzet",
  "seo.weekly.pro.title": "⭐ Professionele artiest (50+ tracks, 5k+ volgers, vaste radio-rotatie)",
  "seo.weekly.pro.desc": "Streaming (aandeel) • Tips • DJ Sessions • Boost",
  "seo.weekly.pro.total": "💵 Aanzienlijk inkomen bij groot, actief bereik",
  "seo.weekly.disclaimer": "⚠️ Inkomen hangt af van muziekkwaliteit, publicatiefrequentie, fan-interactie en gebruik van promotietools. Streaming is een aandeel in de echte omzet van het platform (geen vast tarief per stream); uitbetalingen na het bereiken van het minimum.",
  "seo.why.title": "🎁 Waarom verdient GrouAI Stream meer dan Spotify of SoundCloud?",
  "seo.why.list": "Geen bots|elke stream is een echt persoon = een eerlijker aandeel in de omzet||Multi-channel inkomsten|niet alleen een aandeel uit luisterbeurten, maar ook tips en boosts||85% commissie uit tips voor de artiest|(vs. ~70% marktstandaard)||Organische AI-promotie|het systeem stelt jouw tracks voor aan luisteraars met passende stemming||Transparantie|volledig dashboard met realtime inkomsten",
