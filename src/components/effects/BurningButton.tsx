...
export const BurningButton = ({
  ...
  return (
    <div className={`burning-btn-wrap relative ${className}`}>
      ...
      >
        <span className="relative flex items-center justify-center w-full rounded-2xl bg-background/40 backdrop-blur-[2px] overflow-hidden px-6 py-5 md:py-6">
          {/* Płonące tło wewnątrz przycisku */}
          <span className="burning-btn__inner-fire pointer-events-none absolute inset-0" />

          {/* Migoczące języki ognia od dołu */}
          <span className="burning-btn__flames pointer-events-none absolute inset-x-0 bottom-0 h-full" />

          {/* Wewnętrzne iskierki przebijające napis */}
