        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-6">
          <div className="flex-1 text-center md:text-left">
            <div className="inline-flex items-center gap-2 rounded-full bg-green-500/15 border border-green-500/25 px-3 py-1 text-xs font-medium text-green-400 mb-4">
              ...
              Nowe — Upload z Suno AI
            </div>
            <h2 className="text-2xl md:text-3xl font-bold mb-2">
              Wrzuć swój utwór z Suno
            </h2>
            <p className="text-sm text-muted-foreground max-w-lg">
              Dodaj swój track → badge <span className="text-primary font-medium">AI-Assisted</span> → zarabiaj na verified human streams
            </p>
          </div>
