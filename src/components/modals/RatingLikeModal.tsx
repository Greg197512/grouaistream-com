...
export const RatingLikeModal = ({
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const bonus = (data as any)?.bonus_granted ? ` — wsparłeś artystę 💜` : "";
        ...
        <div className="py-6">
          ...
          {!tooShort && (
            <p className="mt-2 text-center text-[11px] text-muted-foreground">
              💝 Twoje polubienie <span className="text-primary font-semibold">wspiera artystę</span> i dodaje mu punktów
            </p>
          )}
        </div>
